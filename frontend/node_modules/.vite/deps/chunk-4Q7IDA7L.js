...
var FormLabel = React83.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime57.jsxs)(FormLabelRoot, _extends({
    ...
    children: [children2, fcs.required && (0, import_jsx_runtime57.jsxs)(AsteriskComponent, {
      ownerState,
      "aria-hidden": true,
...
var FormControl3 = React85.forwardRef(function FormControl4(inProps, ref) {
  ...
  const [adornedStart, setAdornedStart] = React85.useState(() => {
    ...
    if (children2) {
      React85.Children.forEach(children2, (child) => {
...
var MenuList = React89.forwardRef(function MenuList2(props, ref) {
  ...
  React89.Children.forEach(children2, (child, index2) => {
  ...
  const items = React89.Children.map(children2, (child, index2) => {
...
true ? Modal3.propTypes = {
   ...
   * A function called when a transition enters.
   */
  onTransitionEnter: import_prop_types52.default.func,
  /**
   * A function called when a transition has exited.
   */
  onTransitionExited: import_prop_types52.default.func,
  /**
   * If `true`, the component is shown.
   */
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4Q7IDA7L.js.map
